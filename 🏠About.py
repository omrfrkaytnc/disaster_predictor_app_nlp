...
st.set_page_config(page_title="Disaster Call Classification", page_icon=":computer:",layout="wide")
...
with st.container():
    st.write("---")
    text = """<h4 style= 'text-align: center;'> build by ofa </h4>"""
    st.markdown(text, unsafe_allow_html=True)


title = """<h1 style='text-align: center;'>Disaster Call Classification</h1>"""
